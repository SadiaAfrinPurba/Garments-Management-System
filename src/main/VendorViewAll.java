 ...
 * @author purba
 */
public class VendorViewAll extends javax.swing.JFrame {
     ...
     */
      ...
      public VendorViewAll() {
        ...
        try {
            ...
            Logger.getLogger(BuyerViewAll.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel15.setText("All Vendors Information");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendorViewAll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendorViewAll().setVisible(true);
            }
        });
    }
