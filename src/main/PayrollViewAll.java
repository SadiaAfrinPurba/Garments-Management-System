 ...
 * @author purba
 */
public class PayrollViewAll extends javax.swing.JFrame {

      ShowDatabaseTable viewAll=new ShowDatabaseTable();
      public static final String TABLE_NAME="allowance";
    public PayrollViewAll() {
        initComponents();
        try {
            
            viewAll.UpdateTable(dataTable,TABLE_NAME);
        }catch (SQLException ex) {
            Logger.getLogger(PayrollViewAll.class.getName()).log(Level.SEVERE, null, ex);
        } 
    }
    ...
    private void initComponents() {
        ...
        jLabel15.setText("All Salaries Information");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayrollViewAll.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PayrollViewAll().setVisible(true);
            }
        });
    }
